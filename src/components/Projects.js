...
export const Projects = () => {
  const projects = [
    ...
    },
    {
      title: "To-Do list",
      description:
        "A minimalist to-do list app designed with HTML, CSS, and JavaScript. Efficiently manage your tasks with a clean and intuitive interface.",
      imgUrl: projImg2,
      link: "https://github.com/cheenu12/LGM-Task2-TodoList"
    },
    {
      title: "Drum-Kit",
      description:
